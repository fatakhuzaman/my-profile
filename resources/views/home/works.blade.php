...
<section id="works" class="projects-area innerpage-single-area">
    <div class="container">
            ...
            <div class="row project-masonry-active">
                ...
                <div class="col-lg-4 col-md-6 item branding game">
                    <div class="project-item style-two wow fadeInUp delay-0-3s">
                        <div class="project-image">
                            <img src="{{ asset('images/projects/work1.jpg') }}" alt="Project">
                                <a href="{{ asset('images/projects/work1.jpg') }}" class="details-btn work-popup"><i class="ri-arrow-right-up-line"></i></a>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 item design marketing graphics">
                    <div class="project-item style-two wow fadeInUp delay-0-4s">
                        <div class="project-image">
                            <img src="{{ asset('images/projects/work2.jpg') }}" alt="Project">
                ...
                <div class="col-lg-4 col-md-6 item game graphics">
                    <div class="project-item style-two wow fadeInUp delay-0-5s">
                        <div class="project-image">
                            <img src="{{ asset('images/projects/work3.jpg') }}" alt="Project">
                            <a href="{{ asset('images/projects/work3.jpg') }}" class="details-btn work-popup"><i class="ri-arrow-right-up-line"></i></a>
                        </div>
                        <div class="project-content">
                ...
                <div class="col-lg-4 col-md-6 item design game">
                    <div class="project-item style-two wow fadeInUp delay-0-6s">
                        <div class="project-image">
                            <img src="{{ asset('images/projects/work4.jpg') }}" alt="Project">
                            <a href="{{ asset('images/projects/work4.jpg') }}" class="details-btn work-popup"><i class="ri-arrow-right-up-line"></i></a>
                        </div>
                        <div class="project-content">
                ...
                <div class="col-lg-4 col-md-6 item branding game">
                    <div class="project-item style-two wow fadeInUp delay-0-7s">
                        <div class="project-image">
                            <img src="{{ asset('images/projects/work5.jpg') }}" alt="Project">
                            <a href="{{ asset('images/projects/work5.jpg') }}" class="details-btn work-popup"><i class="ri-arrow-right-up-line"></i></a>
                        </div>
                        <div class="project-content">
                            <span class="sub-title">Branding</span>
                ...
                <div class="col-lg-4 col-md-6 item design marketing graphics">
                    <div class="project-item style-two wow fadeInUp delay-0-8s">
                        <div class="project-image">
                            <img src="{{ asset('images/projects/work6.jpg') }}" alt="Project">
                            <a href="https://www.youtube.com/watch?v=qZEPs3vmYB4" class="details-btn popup-youtube"><i class="ri-arrow-right-up-line"></i></a>
                        </div>
                        <div class="project-content">
                            <span class="sub-title">Design</span>
